...
# run original script: script2b_CHG_hmst_m_v4.sh
...
-fko ../mC_count_Neil1_3/filter_cov15/me_${CHR}_${Type}.bed \
-fko ../mC_count_Neil1_4/filter_cov15/me_${CHR}_${Type}.bed \
-fwt ../mC_count_WT_3/filter_cov15/me_${CHR}_${Type}.bed \
-fwt ../mC_count_WT_4/filter_cov15/me_${CHR}_${Type}.bed \
-g ../in_data/mm10_chrom_length_sorted
...
-cmc out_${Type}_${CHR}/counts_DMR_hypo_hyper_imputed_Ttest_5mC.csv \
...
#-oMR out_${Type}_${CHR}/list_overlapping_MRs.txt #only used for 2 samples, one WT and one KO.
echo plot_all-DONE
